...
1) Первоначально можно скачать репозиторий библиотеки в виде zip-файла или через команду git:
```
...
```
Следующий пример демонстрирует пример работы самой библиотеки после запуска образа:
```
Директория: src/test
```
